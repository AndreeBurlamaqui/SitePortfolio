---
# --- CORE INFORMATION ---
title: "Hopscotch Board Games"
description: "The following digital board games are R&D prototypes focused on high-fidelity UI and VFX implementation. While the final products and client details remain under NDA, these samples showcase the underlying technical execution, interface adaptability, and the rapid prototyping workflows used to validate the game's style."
cover: "/cover/cover-image.webp" # Path to your image in /public

# --- METADATA ---
timeFrame: "Nov 2023"          # User-friendly time frame
sortDate: 2023-11-26              # What the code uses to sort
